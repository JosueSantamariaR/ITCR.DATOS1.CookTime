    ...
    public class CountryComboBox : SfComboBox, INotifyPropertyChanged
    {
        ...
        public CountryComboBox()
        {
            ...
            Countries.Add(new CountryModel()
            {
                ...
                Country = "Time",
                States = new string[] { "Breakfast", "Lunch", "Snack", "Dinner", " Brunch" }
            });
            Countries.Add(new CountryModel()
            {
                Country = "Type",
                States = new string[] { "Snacks", "Starter", "Main Dish", "Alcoholic Beverages", "Cold Drinks", "HotDrinks", "Dessert Drinks" }
            ...
            {
                Country = "DietTag",
                States = new string[] { "Vegetarian", "Vegan", "Keto", "Kosher", "Cold Drinks", "Celiac", "Carnivorous" }
