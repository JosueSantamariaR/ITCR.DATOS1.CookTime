...
namespace CookTime.ViewModels.Catalog
{
    ...
    public class EnterpriseSearchViewModel : BaseViewModel
    {
        #region Fields
        ...
        public void CallAPIsync()
        {
            ...
            var endopoint = client.BaseAddress = new Uri($"http://192.168.1.102:8080/cooktime1/api/services/getEnterpriseMatch/{x}");
